package com.webank.app.stage.common.service.impl;

import com.webank.app.stage.common.service.SysConfigService;
...
import com.webank.pub.common.dao.SysConfigDao;
        ...
        if (StringUtils.isBlank(sysConfig.getConfigValue())) {
            ...
            if (length.compareTo(inputConfig.getConfigValueLength()) > 0) {
                ...
                if (sysConfig.getValueType().equals("integer")) {
                    if (!MyStringUtils.isValidLongNumberForwebank(sysConfig.getConfigValue())) {
