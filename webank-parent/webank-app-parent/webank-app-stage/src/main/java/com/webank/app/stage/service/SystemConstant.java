package com.webank.app.stage.service;

import com.webank.app.stage.common.service.SysConfigService;
import com.webank.app.stage.security.service.*;
...
/**
 * @desc 系统常量管理 从数据库中取出的常用数据 如区域信息 车型信息
 * @author liangyongjian
 * @Version V1.0
 * @create 2017-09-24 下午07:37:50
 */
...
//			this.setMaxImportFileSize();
	 ...
	 * @return
     */
    public String getWeBankApiUrlPrefix() {
		if(!CollectionUtils.isEmpty(getSysConfigMapWithKeyItem())) {
			if (getSysConfigMapWithKeyItem().containsKey("webank_api_url_prefix")) {
				return getSysConfigMapWithKeyItem().get("webank_api_url_prefix").getConfigValue();
			}
		}
		return "";
	}
