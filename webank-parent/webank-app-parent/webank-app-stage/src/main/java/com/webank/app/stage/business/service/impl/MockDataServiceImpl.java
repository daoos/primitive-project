package com.webank.app.stage.business.service.impl;

import com.webank.app.stage.business.service.MockDataService;
import com.webank.app.stage.config.InputConfig;
import com.webank.app.stage.security.service.impl.SysLogContext;
import com.webank.app.stage.service.SystemConstant;
import com.webank.pub.business.dao.MockDataDao;
...
import com.webank.pub.common.constant.EnumResourceDataType;
import com.webank.pub.common.web.PubModelMap;
import com.webank.pub.model.business.po.MockData;
    ...
    public void getMockDataForInitPage(ModelMap model, HttpServletRequest request) {
        ...
        if (!CollectionUtils.isEmpty(mockDataList)) {
            for (MockData mockData : mockDataList) {
                ...
                mockData.setGetInfoApiUrl(systemConstant.getWeBankApiUrlPrefix()
