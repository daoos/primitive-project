...
<div class="header_wrapper">
    <div class="top-container-fluid">
        <div class="row-fluid">
            <img alt="Logo" src="${ctx}/img/webank-logo.png" style="margin: 19px 20px 18px 20px; heigh:28px; width: 238px;" />
            <ul class="user_nav">
