...
public class StringPubUtils  extends StringUtils {
	...
	/**
	 * @desc 根据所给的字符串与编码规范,将字符串解码
	 * @param str
	 * @param codeFormat
	 * @return String
	 * @author liangyongjian
	 * @create 2018-06-24 上午11:51:01
	 * @version V1.0
	 */
	...
	/**
	 * @desc 如果字符串是null或"null"，则返回空值""
	 * @param str
	 * @return String
	 * @author liangyongjian
	 * @create 2017年9月28日 下午1:11:35
	 * @version V1.0
	 */
	...
	/**
	 * @desc 计算百分比，并设置百分数精确度
	 * @param a
	 * @param b
	 * @param bits
	 * @return String
	 * @author liangyongjian
	 * @create 2017年9月28日 下午8:43:01
	 * @version V1.0
	 */
