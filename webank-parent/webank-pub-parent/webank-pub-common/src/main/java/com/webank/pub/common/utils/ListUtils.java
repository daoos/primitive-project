...
public class ListUtils {
	...
	/**
	 * 
	 * @desc 将List中的元素转化成一个字符串,元素之间的分隔符使用指定的分隔符
	 * @param list 元素列表
	 * @param separator 分隔符
	 * @return 
	...
	/**
	 * @desc 将类型是Long的List转换成类型是String的List
	 * @param srcList
	 * @return
	 * @return List<String> 
