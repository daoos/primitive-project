package com.webank.pub.common.spring;
...
/**
 * @desc spring环境工具 实现SpringContextUtils中context参数的初始化，供该类提供springContext的静态get方法使用
 * @author liangyongjian
 * @Version V1.0
 * @create 2018-06-24 下午03:58:56
 */
