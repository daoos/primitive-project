...
public class MyStringUtils extends StringUtils {
	 ...
	 * @Author liangyongjian
	 * @Version V1.0
	 * @Create at 2018-06-27 下午05:38:54
	 */
	 ...
	 * @return
	 */
	public static boolean checkDecimalForwebank(String str){
	 ...
	 * @return
	 */
	public static boolean isValidDecimalForwebank(String str) {
		...
		// 按照小数对待
		if (str.indexOf(".") > 0) {
			return checkDecimalForwebank(str);
		} else {
			//按照整数对待，长度不可大于12
			if (str.length() > 12) {
				return false;
	...
	public static boolean isValidLongNumberForwebank(String str) {
		if (StringUtils.isBlank(str)) {
			return false;
		}
...
//		System.out.println(checkDecimalForwebank("-123456789012.111111111"));
//		System.out.println(isValidDecimalForwebank("0.00000000"));
