...
public class FolderUtils {
	...
	/**
	 * @desc 根据指定的路径创建目录，指定的路径必须是绝对路径
	 * @param folderPhysicalPath
	 * @return void
	 * @author liangyongjian
	 * @create 2017年9月28日 下午11:06:33
	 * @version V1.0
	 */
	...
	/**
	 * @desc 根据指定的文件路径获取到该文件所在的目录，指定的文件路径应该是绝对路径
	 * @param filePhysicalPath
	 * @return String
	 * @author liangyongjian
	 * @create 2017年9月28日 下午11:06:47
	 * @version V1.0
	 */
