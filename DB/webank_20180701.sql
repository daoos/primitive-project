...
MySQL - 5.7.17-log : Database - webank
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`webank` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
...
insert  into `resource_module`(`id`,`module_name`,`sort_num`,`pid`,`create_time`,`create_userid`,`update_time`,`update_userid`,`note`) values (1,'首页',1,0,'2018-06-15 20:31:52',1,'0000-00-00 00:00:00',NULL,'warning'),(2,'数据管理',2,0,'2018-06-15 20:36:28',1,'0000-00-00 00:00:00',NULL,'dataManage'),(3,'用户管理',3,0,'2018-06-15 20:36:07',1,'0000-00-00 00:00:00',NULL,'userManage'),(4,'系统管理',4,0,'2018-06-15 20:36:28',1,'0000-00-00 00:00:00',NULL,'sysManage');
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='系统资源表';

/*Data for the table `resources` */

insert  into `resources`(`id`,`resource_name`,`resource_url`,`module_id`,`sort_num`,`is_restricted`,`is_menu`,`create_time`,`create_userid`,`update_time`,`update_userid`,`note`) values (1,'首页','/warning.do',1,1,0,1,'2018-06-15 20:37:00',1,'0000-00-00 00:00:00',NULL,NULL),(2,'Mock数据','/mockDataManage.do',2,1,1,1,'2018-06-15 21:21:56',1,'0000-00-00 00:00:00',NULL,NULL),(3,'用户管理','/userManage.do',3,1,1,1,'2018-06-15 21:21:56',1,'0000-00-00 00:00:00',NULL,NULL),(4,'查看当前用户信息','/currentUserInfo.do',3,2,0,0,'2018-06-15 21:27:25',1,'0000-00-00 00:00:00',NULL,NULL),(5,'设置当前用户信息','/setCurrentUserInfo.do ',3,3,0,0,'2018-06-15 21:28:25',1,'0000-00-00 00:00:00',NULL,NULL),(6,'修改当前用户密码','/setCurrentUserPassInfo.do',3,4,0,0,'2018-06-15 21:29:24',1,'0000-00-00 00:00:00',NULL,NULL),(7,'当前在线用户','/onlineUserList.do',3,5,1,0,'2018-06-15 21:30:11',1,'0000-00-00 00:00:00',NULL,NULL),(8,'踢掉在线用户','/shotOffOnlineUser.do ',3,6,1,0,'2018-06-15 21:35:16',1,'0000-00-00 00:00:00',NULL,NULL),(9,'日志管理','/sysLog.do',4,1,1,1,'2018-06-15 21:23:24',1,'0000-00-00 00:00:00',NULL,NULL),(10,'系统数据','/sysConfig.do',4,2,1,1,'2018-06-15 21:23:56',1,'0000-00-00 00:00:00',NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='系统角色资源关联表';

/*Data for the table `role_resource` */

insert  into `role_resource`(`id`,`role_id`,`resource_id`,`create_time`,`create_userid`,`update_time`,`update_userid`,`note`) values (1,1,2,'2018-06-15 21:43:51',1,'0000-00-00 00:00:00',NULL,NULL),(2,1,3,'2018-06-15 21:43:55',1,'0000-00-00 00:00:00',NULL,NULL),(3,1,7,'2018-06-15 21:45:14',1,'0000-00-00 00:00:00',NULL,NULL),(4,1,9,'2018-06-15 21:45:14',1,'0000-00-00 00:00:00',NULL,NULL),(5,1,10,'2018-06-15 21:45:20',1,'0000-00-00 00:00:00',NULL,NULL),(6,2,2,'2018-06-15 21:45:23',1,'0000-00-00 00:00:00',NULL,NULL),(7,2,9,'2018-06-15 21:45:30',1,'0000-00-00 00:00:00',NULL,NULL),(8,2,10,'2018-06-15 21:45:30',1,'0000-00-00 00:00:00',NULL,NULL),(9,1,12,'2018-06-15 21:45:38',1,'0000-00-00 00:00:00',NULL,NULL);
...
insert  into `sys_config`(`id`,`config_item`,`config_name`,`config_value`,`value_type`,`config_note`,`create_userid`,`create_time`,`update_userid`,`update_time`) values (1,'image_file_max_size','图片大小限制（M）','10','integer','图片大小属性的最大值，单位 M',1,'2018-11-20 21:23:57',NULL,'0000-00-00 00:00:00'),(2,'front_config_file','前端大屏所需的配置文件','2','file','前端大屏所需的配置文件',1,'2018-11-20 21:23:57',NULL,'0000-00-00 00:00:00'),(3,'webank_api_url_prefix','项目API应用接口URL前缀','http://localhost/webankapi','string','项目API应用接口URL前缀',1,'2018-06-29 12:26:26',NULL,'0000-00-00 00:00:00');
